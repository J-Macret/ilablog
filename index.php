        ...
        <div class="table">
            <div class="cell">
                <div class="content">
                    ...
                    <h1>Mes deux derniers articles :</h1><div class="hr hr100"></div><br>
                       ...
                       <div class="card-deck"><?php
                            ...
                            foreach ($articles as $article): ?>
                                ...
                                <div class="card">
                                    ...
                                    <div class="hr"></div>
                                    <img src="http://placehold.it/500x300"><div class="hr"></div>
                                    <p><?php echo mb_strimwidth($article['content'], 0, 200, "..."); ?></p><br>
                                    <p>Par : <?= $article['author']; ?></p><br>
